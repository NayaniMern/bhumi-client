...
const ViewEnquiries = () => {
  ...
  useEffect(() => {
    axios
      .get(`https://bhumi-server.onrender.com/Enquiries`)
  ...
  const deleteEnq = (enqId) => {
    axios
      .delete(`https://bhumi-server.onrender.com/Enquiries/${enqId}`)
      .then(() => alert("Your Selected Enquiry was Deleted"))
      .catch((err) => console.log(err));
  };
  const getOneRecord = (enqId) => {
    axios
      .get(`https://bhumi-server.onrender.com/Enquiries/${enqId}`)
      .then((res) => {
  ...
  const updateEnq = (e) => {
    e.preventDefault();
    axios
      .put(`https://bhumi-server.onrender.com/Enquiries/${_id}`, {
        name,
        mobile,
        email,
        message,
